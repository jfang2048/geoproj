...
COMMAND_SPECS: dict[str, dict] = {
    "Run pipeline": {
        ...
        "verify": [ROOT / "scripts/run_pipeline.py"],
    },
    "Run spatial QA": {
        "args": [sys.executable, str(ROOT / "scripts/14_quantitative_spatial_qa.py")],
        "verify": [ROOT / "scripts/14_quantitative_spatial_qa.py"],
    },
    "Run lake WQ compute": {
        "args": [sys.executable, str(ROOT / "scripts/lake_wq/run_compute_lake_wq.py")],
        "verify": [ROOT / "scripts/lake_wq/run_compute_lake_wq.py"],
    },
    "Run minimal tests": {
        "args": [sys.executable, "-m", "pytest", "-q",
                 str(ROOT / "tests/test_crs.py"), str(ROOT / "tests/test_paths.py")],
