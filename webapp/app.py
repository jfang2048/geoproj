...
from webapp.utils.style import inject as inject_css

from webapp.utils.data_loaders import (
...
from webapp.utils.dynamic_maps import (
...
from webapp.utils.dynamic_charts import (
...
from webapp.utils.scs_preview import preview_metrics, preview_curve
from webapp.utils.validators import CATEGORY_RULES, validate_upload, accepted_extensions_for
from webapp.utils.upload_registry import record_upload, read_manifest
from webapp.utils.runner import available_commands, run_command
from webapp.utils.paths import (
...
# ===========================================================================
    ...
    with tab_lake:
        ...
        with st.expander("Detected local Sentinel-2 products", expanded=False):
            from webapp.utils.data_loaders import RAINFALL_EVENTS
            import re as _re
